...
void bubble_sort(tVector*); 			//bubble_sort que ordena o vetor jogando os maiores pra frente
void bubbleSortRec(tVector*);			//"interface" da função recursiva
void bubbleSortRecursive(tVector*, int ,int);	//função recursiva realmente